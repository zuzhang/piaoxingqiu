...
import request
import config_person1

'''
目前仅支持【无需选座】的项目
'''
show_id = config_person1.show_id
session_id = config_person1.session_id
buy_count = config_person1.buy_count
audience_idx = config_person1.audience_idx
deliver_method = config_person1.deliver_method
seat_plan_id = config_person1.seat_plan_id
